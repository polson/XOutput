...
{
    private readonly Dictionary<XInputTypes, VigemXbox360AxisMapping> axisMappings = new();
    private readonly Dictionary<XInputTypes, VigemXbox360ButtonMapping> buttonMappings = new();
    private readonly ViGEmClient client;

    private readonly Dictionary<int, IXbox360Controller> controllers = new();
    private readonly Dictionary<XInputTypes, VigemXbox360SliderMapping> sliderMappings = new();
    ...
    public void Dispose()
    {
        foreach (var controller in controllers.Values) controller.Disconnect();
        client.Dispose();
    }
