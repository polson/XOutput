...
public sealed class Settings
{
    ...
    /// <summary>
    ///     Gets the mapper with the given deviceID. If the mapper is not saved in this settings, a new mapper will be
    ///     returned.
    /// </summary>
    ...
    /// <summary>
    ///     Gets the input configuration with the given deviceID. If configuration are not saved in this settings, a new
